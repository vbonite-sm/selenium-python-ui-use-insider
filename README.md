...
```bash
# Clone repository
git clone git@github.com:vbonite-sm/selenium-python-ui-use-insider.git
cd selenium-python-ui-use-insider
...
## Project Structure
```
selenium-python-ui-use-insider/
...
Reports deployed to: `https://vbonite-sm.github.io/selenium-python-ui-use-insider/` (to be fixed)
